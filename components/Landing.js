      ...
      <div className={`${styles.container}`}>
        <div className={`${styles.overlay}`}>
          <div className={styles.content_container}>
            <h1 className={`${styles.hey}`}>Hey I&apos;m <span className={styles.accent_green}>Nathan</span></h1>
            ...
            <h5 className={styles.statement}>A good software developer</h5>
            <h5 className={styles.statement}>trying to become a great one.</h5>
            <br />
          </div>
        </div>
        <a href="#projects">
